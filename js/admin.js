...
function refreshAdmin() {
  ...
  // Atualiza os cards de stats (Com o novo Faturamento Herói)
  document.getElementById('admin-revenue').innerHTML =
    '<span style="font-size:24px;color:rgba(0,0,0,0.15);font-weight:300;font-family:var(--font-serif);font-style:italic">R$&nbsp;</span>' + fmtPrice(revenue);
  document.getElementById('admin-ticket').innerHTML =
    '<span style="font-size:16px;color:var(--gold);font-weight:400">R$&nbsp;</span>' + fmtPrice(ticket);
  document.getElementById('admin-count').textContent   = completed.length + ' atendimento(s)';
