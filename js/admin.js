...
function refreshAdmin() {
  ...
  document.getElementById('admin-revenue').innerHTML =
    '<span style="font-size:16px;color:var(--muted);font-weight:400">R$&nbsp;</span>' + fmtPrice(revenue);
  document.getElementById('admin-ticket').innerHTML =
    '<span style="font-size:16px;color:var(--muted);font-weight:400">R$&nbsp;</span>' + fmtPrice(ticket);
