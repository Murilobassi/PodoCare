/* ============================================================
   ...
   Responsabilidades:
   - Ler/salvar/limpar credenciais (localStorage)
...
/* ── CREDENCIAIS (localStorage — persiste após fechar aba) ── */

function getConfig() {
  return {
    url: localStorage.getItem('pc_url') || '',
    key: localStorage.getItem('pc_key') || '',
  };
}

function saveConfig(url, key) {
  localStorage.setItem('pc_url', url.trim());
  localStorage.setItem('pc_key', key.trim());
}

function clearConfig() {
  localStorage.removeItem('pc_url');
