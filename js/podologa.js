...
function refreshPodologaFin() {
  ...
  document.getElementById('fin-total-val').innerHTML =
    '<span style="font-size:32px;font-weight:500;color:inherit;margin-right:4px">R$</span>' + fmtPrice(totalAll);
  document.getElementById('fin-total-val').style.color = 'var(--teal)';
